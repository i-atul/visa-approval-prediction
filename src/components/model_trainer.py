...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        """
        Method      :   This function uses neuro_mf to get the best model object and report of the best model
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        """
        Method      :   This function initiates a model trainer steps
        ...
        try:
            ...
            visa_model = MyModel(preprocessing_object=preprocessing_obj,
